...
function initButton(sfHost, inInspector) {
  ...
  function calcPopup({popupArrowOrientation: o, popupArrowPosition: pos, popupHeighDynamictMode: dynamicHeight}) {
    ...
    const imgSrc = isVertical
      ? "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'%3E%3Cpath d='M14 7l-5 5 5 5' stroke='%232196f3' stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E"
      : "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'%3E%3Cpath d='M7 10l5 5 5-5' stroke='%232196f3' stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E";
    let btnClasses = [];
  ...
  function loadPopup(sfHost) {
    ...
    addEventListener("message", e => {
      ...
      if (e.data.insextShowApiName) {
        ...
        if (e.data.btnLabel && e.data.btnLabel.startsWith("Show")){
          document.querySelectorAll("record_flexipage-record-field > div, records-record-layout-item > div, div .forcePageBlockItemView").forEach(field => {
            ...
            if (label && field.dataset && field.dataset.targetSelectionName && label.querySelector("mark") == null){
